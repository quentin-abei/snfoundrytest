...
#[starknet::interface]
pub trait ISimpleRewards<TContractState> {
...
/// Careful if using non-standard ERC20 tokens, as they might break things.
    ...
    fn constructor(ref self: ContractState,
        ...
        self.rewardsToken.write(ERC20ABIDispatcher { contract_address: _rewards_token });
    ...
    impl PrivateFunctions of PrivateFunctionsTrait {
       ...
       fn _stake(ref self: ContractState, user: ContractAddress, amount: u256) {
          ...
          self.stakingToken.read().transfer_from(user, this, amount);
       ...
       fn _unstake(ref self: ContractState, user: ContractAddress, amount: u256) {
          ...
          self.totalStaked.write(self.totalStaked.read() - amount);
          self.userStake.write(user, self.userStake.read(user) - amount);
          self.stakingToken.read().transfer(user, amount);
    ...
    #[abi(embed_v0)]
    impl SimpleRewardsImpl of super::ISimpleRewards<ContractState> {
        /// @notice Stake tokens.
